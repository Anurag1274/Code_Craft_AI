        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8 ">
          <div className="bg-white rounded-lg shadow-lg p-8 w-80 flex flex-col items-center">
            ...
            <ul className="text-left mb-4">
              <li className="mb-2">
                <span className="text-blue-500">✓</span> 50,000 Words/Month
              </li>
              <li className="mb-2">
                <span className="text-blue-500">✓</span> 50+ Content Templates
              </li>
              <li className="mb-2">
                <span className="text-blue-500">✓</span> Unlimited Download &
                Copy
              </li>
              <li>
                <span className="text-blue-500">✓</span> 1 Month of History
              </li>
            </ul>
            <button className="flex gap-2 items-center bg-blue-500 text-white rounded-full px-10 py-2 mt-3 hover:bg-blue-700 hover:scale-105">
              Your Active Plan
            </button>
          </div>
          <div className="bg-white rounded-lg shadow-lg p-8 w-80 flex flex-col justify-center items-center">
            ...
            <ul className="text-left mb-4">
              <li className="mb-2">
                <span className="text-blue-500">✓</span> 5,00,000 Words/Month
              </li>
              <li className="mb-2">
                <span className="text-blue-500">✓</span> 50+ Template Access
              </li>
              <li className="mb-2">
                <span className="text-blue-500">✓</span> Unlimited Download &
                Copy
              ...
              <li>
                <span className="text-blue-500">✓</span> 1 Year of History
              </li>
            </ul>
            <button
